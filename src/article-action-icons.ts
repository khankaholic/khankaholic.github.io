import type { AssistantId } from "./assistant-links";
...
export function markdownIcon(): string {
  return `
    <svg class="article-markdown-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" aria-hidden="true">
...
export function assistantIcon(id: AssistantId): string {
  switch (id) {
    case "claude":
      return `
        <svg class="ai-menu-icon ai-menu-icon-claude" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" aria-hidden="true">
    ...
    case "chatgpt":
      return `
        <svg class="ai-menu-icon ai-menu-icon-openai" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" aria-hidden="true">
...
export function chevronIcon(): string {
  return `
    <svg class="article-copy-chevron" viewBox="0 0 24 24" aria-hidden="true">
      <path class="article-copy-chevron-down" d="m7 10 5 5 5-5"></path>
      <path class="article-copy-chevron-up" d="m7 14 5-5 5 5"></path>
    </svg>
  `;
}

export function externalArrow(): string {
  return `
    <svg class="article-copy-external" viewBox="0 0 24 24" aria-hidden="true">
